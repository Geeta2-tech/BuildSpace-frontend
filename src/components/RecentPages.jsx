          ...
          >
            <div className="flex flex-col items-center text-center">
              <div className="w-12 h-12 bg-gray-700 rounded-lg flex items-center justify-center mb-3">
                {page.id === 2 ? (
                  <div
                    className="w-8 h-8 bg-yellow-600 rounded"
                    style={{
                      backgroundImage:
                        'url("data:image/svg+xml,%3Csvg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"%3E%3Cpath d="M3 3h18v18H3V3z" fill="%23F59E0B"/%3E%3Cpath d="M8 8h8v2H8V8zm0 4h8v2H8v-2z" fill="white"/%3E%3C/svg%3E")',
                    }}
                  />
                ) : page.name === 'Task List' ? (
